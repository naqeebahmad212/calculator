...
const HeroSecton = () => {
  ...
  //   typeof window !== "undefined" && localStorage.getItem("ratings")
  ...
  const calculate = React.useRef(null);
  const directIndirect = React.useRef(null);
          ...
          <div className="lg:w-[98%] my-0 mx-auto content relative">
            <div className=" w-[100%] lg:justify-center flex flex-1 flex-col lg:flex-row gap-5">
                    ...
                    <div className=" w-[100%] mx-auto flex flex-col justify-center items-center mb-[20px]">
                      ...
                      <div className="card w-80 lg:w-96 mb-4 shadow-2xl bg-base-100 ">
                        <div className="w-full p-5 text-lg rounded-md hover:scale-[1.1] transition-all duration-75 shadow-xl bg-blue-950 text-white">
                          <p>
                            Checkout 55 similar business planning calculator
                          </p>
                        </div>
              ...
              <div className="content calculator-details w-[full] lg:w-[520px] flex flex-col items-center">
                <div className=" py-5 border-b border-gray-300 text-center lg:text-start">
                ...
                <div className="p-5">
                  <p>
                    ...
                    with a step by step procedure including the related labor
                    cost formulas. After reading you will be able to better
                    answer "How much does an employee cost?"
                  </p>
                  <br />
                  <p>
                ...
                <div className="devider h-14 lg:h-[50px]"></div>

                <div
                  ref={content}
                  className="contents-sec p-10 sticky top-[0px]"
                >
                  <div ref={laborCost} id="lobor-cost" className="pt-[80px]">
                    <h2 className="font-bold text-3xl py-5">
                      What are labor costs?
                    </h2>
                    <p>
                      If you were running a business and reached a point where
                      you were considering hiring someone, or you already have
                      an employee, one of the first questions comes to your mind
                      was probably "How much does an employee cost?" So what is
                      labor cost?{" "}
                      <strong>
                        Labor cost is the sum of all wages paid to employees{" "}
                      </strong>{" "}
                      which include not only remunerations for the actual work
                      but also cover other expenses such as the cost of employee
                      benefits and payroll taxes paid by an employer. The
                      following list includes the most common additional
                      expenses, which can all be part of the labor cost
                    </p>
                    <ul>
                  ...
                  <div id="direct-indirect" className="pt-[80px]">
                    <h2 className="font-bold text-3xl py-5">
                      Direct and indirect labor costs
                    </h2>
                    <p>
                      ...
                      production. In contrast, wages related to support labor
                      and production, such as employees who maintain the factory
                      ...
                      that depends on the factory's output is a variable cost.
                      On the other hand, fixed labor costs cover employees'
                      labor, mostly with long-term contracts that don't depend
                      much on production.
                    </p>
                  </div>

                  <div id="cost-calculator" className="pt-[60px]">
                    <h2 className="font-bold text-3xl py-5 ">
                      How to calculate labor cost
                    </h2>
                    <p>
                      Our labor cost calculator applies the below procedure
                      explained through an example for a hypothetical
                      restaurant.
                    </p>
                    ...
                    <div>
                      <div className="mt-3">
                        ...
                        If your employees work full-time, they will typically
                        work{" "}
                        ...
                        you need to know how many days an employee is absent in
                        a year. If you would like to apply the labor cost
                        calculation on a future employee, you can take the
                        current staff's average number. For example, suppose a
                        typical employee is absent 15 days a year due to a
                        holiday or illness. In that case, you can get the yearly
                        days of absence quickly by multiplying by the daily
                        working hours (or weekly hours divided by working days),
                        ...
                        As we stated at the beginning, to get the real labor
                        cost, you need to include all related expenses related
                        to employment. Other annual costs = Taxes + Insurance +
                        ...
                        arrive at the main labor cost formula, which tells us
                        how much an employee costs in a year:
                        <span className="bg-gray-300 ">
                          Annual payroll labor cost = Gross pay + Other annual
                          costs
                        </span>
                        Let's say the additional costs are 3,900 dollars per
                        year. To get the annual labor cost, you need to add this
                        to the Gross pay, which was 20,800 dollars:{" "}
                        <span className="bg-gray-300">
                          20,800 + 3,900 = 24,700.
                        </span>
                        <h3 className="font-bold py-3">
                        ...
                        hours. Dividing the 24,700 dollars payroll cost by the
                        new hours worked, we get a 12.60 dollars actual hourly
                        labor cost.
                        <h3 className="font-bold py-3">
                          {" "}
                          6. Approximate labor cost percentage.
                        </h3>
                        For a better insight into how much an employee costs,
                        you can also check the labor cost percentage, which is
                        the relationship between your labor cost and your total
                        revenue over a period. So how to calculate the labor
                        cost percentage? Just apply the following labor cost
                        percentage formula to get the answer.
                        <span className="bg-gray-300">
                        ...
                        Note that the acceptable labor cost percentages are
                        around 25 and 40 percent for a restaurant. The ratio
                        varies by industry, however. For example, businesses in
                        the service sector might expect the ratio to be 50
                        percent or more, but the figure may be under 30 percent
                        in the manufacturing sector.
                      </div>
                    </div>
                  </div>

                  <div id="faqs" className="FAQ mt-7 pt-[80px]">
                    <div>
                      <h2 className="font-bold text-3xl py-5">FAQs?</h2>
